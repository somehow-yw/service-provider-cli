(function (window) {
    ...
    req.openHome = (data, callback)=>{
        return send({type: 'get', url:'/api/customer/home', data:data, callback:callback});
    };

    //收藏列表;
    req.collections = (data, callback)=>{
        return send({type: 'get', url:'/api/customer/collections', data:data, callback:callback});
    };

    //添加收藏;
    req.collectionsAdd = (data, callback)=>{
        return send({type: 'post', url:'/api/customer/collections/add', data:data, callback:callback});
    };

    //删除收藏;
    req.collectionsDel = (data, callback)=>{
        return send({type: 'post', url:'/api/customer/collections/del', data:data, callback:callback});
    };
