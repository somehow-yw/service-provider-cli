(function (window) {
    ...
    * */
    ...
    req.collections = (data, callback)=>{
        return send({type: 'get', url:'/mock/buyer/collections.json', data:data, callback:callback});
    };

    //添加收藏;
    req.collectionsAdd = (data, callback)=>{
        return send({type: 'get', url:'/mock/buyer/collectionsAdd.json', data:data, callback:callback});
    };

    //删除收藏;
    req.collectionsDel = (data, callback)=>{
        return send({type: 'get', url:'/mock/buyer/collectionsDel.json', data:data, callback:callback});
    };
