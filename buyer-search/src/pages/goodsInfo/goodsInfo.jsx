            ...
            return (
                <div id="goodsInfoWrap" className="goods-info-wrap" style={{bottom: $.seller && 0}}>
                    <div className="scroller">
                        <div className="nothing-goods-info"></div>
                        <div style={{marginTop: '30px', marginBottom: '30px', textAlign: 'center'}}>无法查看该商品</div>
                        <div style={{textAlign: 'center'}}><a href="javascript: history.back()" className="btn btn-primary">返回</a></div>
                    </div>
                </div>
            );
        }
