...
class member extends React.Component {
    ...
    jump(e){
      ...
      this.setState({
          open_id : e.target.dataset.id
      });
      window.location.href = '#/seller/member/permissions';
    }
    ...
    createList(){
        ...
        this.state.memberList.map((member, index)=>{
            list.push(<div key={index} className="li">
                ...
                <h5 className="pull-right text-orange set-permissions-for-members" data-id={member.wechat_openid} onClick={this.jump.bind(this)}>设置权限</h5>
            </div>);
        });
