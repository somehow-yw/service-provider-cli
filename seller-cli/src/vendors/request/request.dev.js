(function (window) {
  ...
  req.permission = (data = {}, callback) => {
    return send({type: 'get', url: 'api/shop/permission', data: data, callback: callback});
  };
  // 获取某个管理员权限接口
  req.userPermission = (data = {}, callback) => {
    return send({type: 'post', url: 'api/shop/permission/member', data: data, callback: callback});
  };
  // 设置/取消权限
  req.editPermission = (data = {}, callback) => {
    return send({type: 'post', url: 'api/shop/permission/member/edit', data: data, callback: callback});
  };
