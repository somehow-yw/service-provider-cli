(function (window) {
  ...
  * */
  ...
  // 获取服务商权限接口
  req.permission = (data = {}, callback) => {
    return send({type: 'get', url: '/mock/shop/permission.json', data: data, callback: callback});
  };
  // 获取某个管理员权限接口
  req.userPermission = (data = {}, callback) => {
    return send({type: 'post', url: '/mock/shop/permission_member.json', data: data, callback: callback});
  };
  // 设置/取消权限
  req.editPermission = (data = {}, callback) => {
    return send({type: 'post', url: '/mock/shop/permission_member_edit.json', data: data, callback: callback});
  };
  window.$.req = req;
})(window);
